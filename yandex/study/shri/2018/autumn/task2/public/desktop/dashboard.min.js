...
/* begin: ../../desktop.blocks/favorite-devices/favorite-devices.js */
            ...
            inited: function() {
                this._domEvents().on('click', function(ev){
                	...
                	if ($(ev.target).is('.badges__badge')) {
                        ...
                        $(ev.target).siblings().removeClass('badges__badge_selected_no').removeClass('badges__badge_selected_yes');
                		$(ev.target).siblings().addClass('badges__badge_selected_no');
                		$(ev.target).removeClass('badges__badge_selected_no').addClass('badges__badge_selected_yes');
                		
                		var cur_filter_id = $(ev.target).data('value').id;
                		var devices = $(ev.target).parents('.favorite-devices').eq(0).find('.device');
                		devices.map(function(id){
                			$(devices[id]).removeClass('device_invisible');
                			// console.log($(devices[id]).data('value'));
                			if ($(devices[id]).data('value').filter_ids.indexOf(cur_filter_id)==-1) {
                				$(devices[id]).addClass('device_invisible');
                			}
                		});
                		$(ev.target).parents('.favorite-devices').eq(0).find('.favorite-devices__scroller').trigger('scroll');
                		// device_invisible
...
/* end: ../../desktop.blocks/favorite-devices/favorite-devices.js */
